function [w, sse, err] = train_backpropagation(images,labels)
...
[m0 n0]=size(images);
images = [ones(1,n0);images]; %bias + imagens
...
if strcmp(func_ativacao, 'logistica')
    ...
    for i = 1:60000
       if labels(i) == 0
            d(n_saidas, i) = 0.9;   % valores para as saidas que
